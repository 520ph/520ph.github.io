...
let colors = [
    {
        color:'#ffcc00',
        gradColor:['#fff','#ffcc00','rgba(255, 255, 255, 0)']
    },
    {
        color:'#52acdb',
        gradColor:['#fff','#52acdb','rgba(255, 255, 255, 0)']
    },
    {
        color:'#5276db',
        gradColor:['#fff','#5276db','rgba(255, 255, 255, 0)']
    },
    {
        color:'#9952db',
        gradColor:['#fff','#9952db','rgba(255, 255, 255, 0)']
    },
    {
        color:'#db52d3',
        gradColor:['#fff','#db52d3','rgba(255, 255, 255, 0)']
    },
    {
        color:'#52dbcc',
    ...
    {
        color:'#5652db',
        gradColor:['#fff','#5652db','rgba(255, 255, 255, 0)']
    },
    {
        color:'#db9952',
        gradColor:['#fff','#db9952','rgba(255, 255, 255, 0)']
    }
];
