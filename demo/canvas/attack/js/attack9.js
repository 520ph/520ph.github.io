...
let colors = [
    {
        color:'#ff4200',
        gradColor:['#fff','#ff4200','rgba(255, 255, 255, 0)']
    },
    {
        color:'#ff7e00',
        gradColor:['#fff','#ff7e00','rgba(255, 255, 255, 0)']
    },
    {
        color:'#ffde00',
        gradColor:['#fff','#ffde00','rgba(255, 255, 255, 0)']
    },
    {
        color:'#36ff00',
        gradColor:['#fff','#36ff00','rgba(255, 255, 255, 0)']
    },
    {
        color:'#4c90b3',
        gradColor:['#fff','#4c90b3','rgba(255, 255, 255, 0)']
    },
    {
        color:'#52dbcc',
        gradColor:['#fff','#52dbcc','rgba(255, 255, 255, 0)']
    },
    {
        color:'#ff006c',
        gradColor:['#fff','#ff006c','rgba(255, 255, 255, 0)']
    },
    {
        color:'#47dee7',
        gradColor:['#fff','#47dee7','rgba(255, 255, 255, 0)']
    }
];
...
function tranColor(r,g,b,a){
    ...
    imgCtx.drawImage(defImg, 0, 0,60,60);
    let imgData = imgCtx.getImageData(0, 0, 60, 60);
...
function start (arr,
    ...
    for (let i = 0,len = arr.length; i < len; i++) {
        ...
        line.y = coord[0][1];
        //画线
        line.graphics.beginLinearGradientStroke (color.gradColor,[0,0.05,0.8,1],0,0, -line.pox,-line.poy).setStrokeStyle(lineWidth).moveTo(0,0).lineTo(-line.pox,-line.poy);
        ...
        //缩放为0
        sourceCircle.scaleX = sourceCircle.scaleY = line.scaleX = line.scaleY = 0;
